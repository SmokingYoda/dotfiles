...
Set-Location -Path "C:\Users\SmokingYoda\"

# Sets starship config file
$ENV:STARSHIP_CONFIG = "C:\Users\SmokingYoda\Documents\.config\starship\starship.toml"

# Invokes starship
Invoke-Expression (& 'C:\Program Files\starship\bin\starship.exe' init powershell --print-full-init | Out-String)

# Code completion for powershell
